        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li
                        class="nav-item dropdown {{ Route::is('operator.tenaga-pendidik.home') ? 'active' : (Route::is('operator.tenaga-kependidikan.home') ? 'active' : (Route::is('operator.ruangan.home') ? 'active' : '')) }}">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item {{ Route::is('operator.tenaga-pendidik.home') ? 'active' : 'home' }}"
